		...
		<section class="section">
			<div class="card">
				<div class="card-header">
					<h5 class="card-title">Editar Dueños</h5>
				</div>
				<div class="card-body">
					...
					<form class="form" id="editarDueno" method="post">
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
										...
										<div class="card-body">
											...
											<div class="row">
												...
												if (isset($_GET['ID'])) {
													include 'includes/conexion.php';
													$cod = $_GET['ID'];
													$query = oci_parse($conexion, "SELECT * FROM DUENO WHERE ID_DUENO = '$cod'");
													oci_execute($query);
													$cod = $_GET['ID'];
													while ($row = oci_fetch_array($query, OCI_ASSOC + OCI_RETURN_NULLS)) {
														$id_medico =  $row['ID_DUENO'];
												...
												?>
														<div class="col-md-6 col-12">
															<div class="form-group">
																...
																<input type="number" class="form-control" id="id_dueno" name="id_dueno" min="00001" max="99999" value="<?php echo $id_medico ?>" readonly="true">
															</div>
														</div>
														<div class="col-md-6 col-12">
															<div class="form-group">
								...
								<div class="col-12 d-flex justify-content-end">
									<input type="hidden" class="btn btn-primary me-1 mb-1" id="tipo" value="editarDueno">
